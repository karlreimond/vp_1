 ...
 //kui vajutati stuudio nuppu
  ...
  if(isset($_POST["rolesubmit"])){
	  ...
	  if(!empty($_POST["filmpersoninput"]) and !empty($_POST["filminput"]) and !empty($_POST["filmpositioninput"])){
		  $rolenotice = storenewrolerelation($selectedfilm, $selectedperson, $selectedposition, $role);
	 }
  }
...
<body>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<label for="titleinput">Stuudio nimi:</label>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<br>
	<label for="titleinput">Perekonnanimi:</label>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<input type="text" name="roleinput" id="roleinput" placeholder="Roll"><span><?php echo $addrolenotice; ?></span>
	<br>
	<br>
	<input type="submit" name="rolesubmit" value="Salvesta inimese ja filmi seose info"><span><?php echo $rolenotice; ?></span>
  </form>
  <hr>
